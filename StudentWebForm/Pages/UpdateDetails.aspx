<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateDetails.aspx.cs" Inherits="StudentWebForm.Pages.UpdateDetails" %>
...
<body>
    <form id="form1" runat="server">
        <div class="auto-style5" style="border: thin solid #000000; margin: auto;">
            <h1 style="font-family: Arial, Helvetica, sans-serif; font-size: xx-large; font-weight: bold; color: #FF00FF; text-align: center; background-color: #00FF00; border-style: solid; border-width: thin">Student Update Details</h1>
            <table class="w-100" style="border-style: solid; border-width: thin; font-family: Arial, Helvetica, sans-serif; font-size: x-large; font-weight: bold; color: #333333; background-color: #FFFFFF;">
                ...
                <tr>
                    <td colspan="2">
                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                        <asp:Button ID="Button6" runat="server" BackColor="#FF3399" Font-Size="Large" ForeColor="White" OnClick="Update" Text="Update" BorderColor="Black" Width="122px" ValidationGroup="reg" />
                        &nbsp;</td>
                </tr>
        </table>
      </div>
